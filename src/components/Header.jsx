            ...
            <div className="flex flex-wrap justify-between items-center mx-auto px-0">
              ...
              {/* ----- */}
                <div id='nav-links' className={`${hiddenSearch ? 'hidden' : ''} items-center justify-between w-full md:flex md:w-auto md:order-1"} id="navbar-search`}>
                  ...
                  <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row lg:space-x-8 md:space-x-3 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
