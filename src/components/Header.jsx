              ...
              {/* ----- */}
                <div id='nav-links' className={`${hiddenSearch ? 'hidden' : ''} items-center justify-between w-full md:flex md:w-auto md:order-1"} id="navbar-search`}>
                  ...
                  <ul className="flex flex-col p-4 pt-5 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row lg:space-x-8 md:space-x-2 md:mt-0 text-xl md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                      <NavLink to="/" onClick={() => setHiddenSearch(!hiddenSearch)} className={ ({isActive}) => isActive ? activeClass : inactiveClass } end><span className="md:text-lg lg:text-2xl">Showing</span></NavLink>
                    </li>
                    <li>
                      <NavLink to="/movies/popular" onClick={() => setHiddenSearch(!hiddenSearch)} className={ ({isActive}) => isActive ? activeClass : inactiveClass }><span className="md:text-lg lg:text-2xl">Popular</span></NavLink>
                    </li>
                    <li>
                      <NavLink to="/movies/top" onClick={() => setHiddenSearch(!hiddenSearch)} className={ ({isActive}) => isActive ? activeClass : inactiveClass }><span className="md:text-lg lg:text-2xl">Top Rated</span></NavLink>
                    </li>
                    {/* <li>
                      <NavLink to="movies/nowPlaying" className={ ({isActive}) => isActive ? activeClass : inactiveClass }>Now Playing</NavLink>
                    </li> */}
                    <li>
                      <NavLink to="/movies/upcoming" onClick={() => setHiddenSearch(!hiddenSearch)} className={ ({isActive}) => isActive ? activeClass : inactiveClass }><span className="md:text-lg lg:text-2xl">Upcoming</span></NavLink>
                    </li>
                  </ul>
                </div>
              </div>
...
// const [hiddenLanguage, setHiddenLanguage] = useState(true);